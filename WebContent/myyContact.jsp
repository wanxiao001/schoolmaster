	...
	<body style="background: #ebebeb;">
		...
		<div class="index-content">
			...
			<table class="index-content-table-add">
					<tr>
						<td width=120px height=20px><b>昵称</b></td>
						<td width=600px height=20px><b>留言</b></td>
						<td width=600px height=20px><b>QQ</b></td>
						<td width=600px height=20px><b>email</b></td>
						<td width=100px height=20px><b>预约时间</b></td>
					</tr>
					<s:iterator id="contact">
					<tr class="index-content-table-td">
					<td width=200px height=100px ><s:property value="#contact.contacter"/></td>
					<td width=600px height=100px ><s:property value="#contact.message"/></td>
					<td width=100px height=100px ><s:property value="#contact.QQ"/></td>
					<td width=100px height=100px ><s:property value="#contact.email"/></td>
					<td width=300px height=100px ><s:property value="#contact.contactTime"/></td>
					</tr>
					</s:iterator>
				</table>
		</div>
