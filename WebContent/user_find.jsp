	...
	<body>
		...
		<div class="index-content">
			<div class="index-content-operation">
				<div class="index-content-operation-usersearch"><input id="search_username" placeholder="请输入服务关键字" type="text" name="fskill" onKeyDown="webchat_chkkeysend(event);"/><button onclick="searchUser()">搜索</button></div>
			</div>
			<br>
			<table class="index-content-table">
				<s:iterator id="user1">
					<tr class="index-content-table-td">
					<td width=200px height=50px >昵称：<s:property value="#user1.userName"/></td>
					<td width=400px height=50px >擅长：<s:property value="#user1.skill"/></td>
					<td width=100px height=50px >获赞数：<s:property value="#user1.star"/></td>
					<td><a class="index-content-table-td-edit" href='user_look.action?id=<s:property value="#user1.id"/>'>查看</a></td>
					</tr>
				</s:iterator>		
			</table>
		</div>
